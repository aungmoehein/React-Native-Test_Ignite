...
// Styles
import styles from './Styles/UpComingViewStyle'
...
class UpComingView extends Component {
  ...
  getData = async () => {
    ...
    const ZatKars = await api.getUpComingSchedule()
 ...
 renderRow (rowData, navigation) {
    return (
      <TouchableHighlight onPress={() => navigation.navigate("UpComingDetailScreen",{zatkar: rowData})}>
...
export default connect(mapStateToProps, mapDispatchToProps)(UpComingView)
